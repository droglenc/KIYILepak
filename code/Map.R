...
gl <- readOGR("c:/aaaWork/Research/KIYILepak/data/clean","glgis_gl_shore_noaa_70k")
...
## Make the map
png("results/figures/Figure1_SamplesMap.png",width=wid,height=hig,
...
## Use to show location codes ... not in manuscript, just as a check
#with(sta,text(longitude,latitude,location,cex=0.4))

## Setup Regions ... not in manuscript, didn't like
# Get region boundary locations
# reg <- read_excel("data/raw/KIYILepak_2014.xlsx",sheet="Regions")
