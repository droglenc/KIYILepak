...
## Vectors of region names
regS <- c("West","Isle","North","South","East")
regL <- c("Western Arm","N. Michigan","N. Ontario",
          "S. Ontario","E. Michigan")
regPts <- c(3,4,17,15,16)
...
setwd("C:/aaaWork/Research/KIYILepak/manuscript/Map")
gl <- readOGR(".","glgis_gl_shore_noaa_70k")
...
points(sta$longitude,sta$latitude,cex=0.6,pch=regPts[sta$region])
...
legend("topleft",regL,pch=regPts,bty="n",cex=0.7,inset=0.01)
dev.off()
