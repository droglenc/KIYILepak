...
with(growth,
     plotCI(jitage,mntl,ui=uci,li=lci,xlim=c(1,11.1),ylim=c(80,220),
            sfrac=0,pch=20,cex=0.65,xlab="Age",ylab="Total Length (mm)"))
